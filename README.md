# [Device42 WordPress Theme](http://www.device42.com)

Device42 customized WordPress theme.

* Project: [bitbucket.org/web_docs/wp-device42](https://bitbucket.org/web_docs/wp-device42)
* Website: [device42.com](http://www.device42.com)
* Author : [David Amato](http://www.device42.com)

## Getting Started with `wp-device42`

Theme is self-contained, and requires `php-xml` library installed (via apt-get) for the installed PHP version


## Features

### Live header and footer
* The header and footer contents is scraped from www.device42.com for sub-site consistancy  
