<?php
class d42_archive_widget extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'classname' => 'd42_archive_widget',
            'description' => __( 'A list or dropdown of past archives, customized for Device42.' ),
            'customize_selective_refresh' => true,
        );
        parent::__construct('d42-archives-widget', __('D42 Archives'), $widget_ops);
    }
    ...
    public function widget( $args, $instance ) {
        ...
        <div class="custom-collapse">
        	<button class="collapse-toggle visible-xs btn btn-block btn-primary" type="button" data-toggle="collapse" data-parent="custom-collapse" data-target="#archives-collapse">Archives</button>
        <ul class="list-group collapse" id="archives-collapse">
        <?php
        /**
